...
const SOCIAL_ICON_MAP: Record<SocialIconName, Omit<SupportedIconMeta, "name">> =
  {
...
export const SUPPORTED_SOCIAL_ICONS: SupportedIconMeta[] = SOCIAL_ICON_NAMES.map(
  (name) => ({ name, ...SOCIAL_ICON_MAP[name] }),
);
