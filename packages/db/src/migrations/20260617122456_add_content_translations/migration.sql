...
CREATE UNIQUE INDEX "achievement_translations_achievement_locale_uq" ON "achievement_translations" ("achievement_id","locale");--> statement-breakpoint
CREATE INDEX "experience_translations_experience_id_idx" ON "experience_translations" ("experience_id");--> statement-breakpoint
CREATE UNIQUE INDEX "experience_translations_experience_locale_uq" ON "experience_translations" ("experience_id","locale");--> statement-breakpoint
CREATE INDEX "profile_translations_profile_id_idx" ON "profile_translations" ("profile_id");--> statement-breakpoint
CREATE UNIQUE INDEX "profile_translations_profile_locale_uq" ON "profile_translations" ("profile_id","locale");--> statement-breakpoint
CREATE INDEX "project_translations_project_id_idx" ON "project_translations" ("project_id");--> statement-breakpoint
CREATE UNIQUE INDEX "project_translations_project_locale_uq" ON "project_translations" ("project_id","locale");--> statement-breakpoint
