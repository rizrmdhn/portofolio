...
CREATE TABLE "portofolio-webpage-v5_application_settings" (
	"id" uuid PRIMARY KEY,
	"key" varchar(256) NOT NULL CONSTRAINT "portofolio-webpage-v5_application_settings_key_unique" UNIQUE,
	"data" jsonb NOT NULL,
...
ALTER TABLE "portofolio-webpage-v5_sessions" ADD CONSTRAINT "portofolio-webpage-v5_sessions_userId_portofolio-webpage-v5_use" FOREIGN KEY ("userId") REFERENCES "portofolio-webpage-v5_users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "portofolio-webpage-v5_project_views" ADD CONSTRAINT "portofolio-webpage-v5_project_views_projectId_portofolio-webpag" FOREIGN KEY ("projectId") REFERENCES "portofolio-webpage-v5_projects"("id") ON DELETE CASCADE;
*/