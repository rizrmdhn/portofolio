...
function getThemeScript(storageKey: string, defaultTheme: Theme) {
  ...
  return `(function(){try{var t=localStorage.getItem(${key});if(t!=='light'&&t!=='dark'&&t!=='system'&&t!=='warm'){t=${fallback}}var d=matchMedia('(prefers-color-scheme: dark)').matches;var r=t==='system'?(d?'dark':'light'):t;var e=document.documentElement;e.classList.remove('light','dark','warm');e.classList.add(r);e.style.colorScheme=t==='warm'?'light':r}catch(e){}})();`
}
...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    setThemeState(
      stored === 'light' || stored === 'dark' || stored === 'system' || stored === 'warm'
        ? stored
        : defaultTheme,
    )
    setMounted(true)
