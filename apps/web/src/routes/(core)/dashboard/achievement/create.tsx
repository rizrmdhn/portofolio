...
import { createAchievementSchema } from '@portofolio/schema/achievement.schema'
...
export const Route = createFileRoute('/(core)/dashboard/achievement/create')({
  ...
  return (
    <div className="flex min-h-[calc(100svh-var(--header-height)-2rem)] flex-1 flex-col gap-4">
      <div className="flex flex-col gap-1">
        <h2 className="text-foreground text-base font-bold">Add Achievement</h2>
        <p className="text-muted-foreground text-xs">Add a new achievement to your resume.</p>
      </div>
