...
import { PROFICIENCY_LABELS, PROFICIENCY_LEVELS } from '@portofolio/constants'
...
export const Route = createFileRoute('/(core)/dashboard/tech-stack/$techStackId/edit')({
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        onValueChange={(v) => onProficiencyChange(Number(v) as ProficiencyLevel)}
      >
  ...
  return (
    <div className="flex min-h-[calc(100svh-var(--header-height)-2rem)] flex-1 flex-col gap-4">
      <div className="flex flex-col gap-1">
        <h2 className="text-foreground text-base font-bold">Edit Tech Stack Category</h2>
                              ...
                              {items.map((item, index) => (
                                <SortableItem
                                  ...
                                  onProficiencyChange={(value) =>
                                    field.handleChange(
                                      items.map((it, i) =>
                                        i === index ? { ...it, proficiency: value } : it,
                                      ),
                                    )
                                  }
