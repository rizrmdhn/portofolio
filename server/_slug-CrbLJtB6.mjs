...
import { C as DialogRoot, D as DialogClose, O as DialogBackdrop, S as DialogTitle$1, T as DialogPopup, mt as require_react, pt as require_jsx_runtime, w as DialogPortal$1, x as DialogTrigger$1 } from "./_libs/@base-ui/react+[...].mjs";
import { $ as IconExternalLink, Ct as IconBrandGithub, Et as IconBrandAppstore, Nt as IconArrowLeft, St as IconBrandGooglePlay, Z as IconEye, jt as IconArrowUpRight, r as IconX } from "./_libs/tabler__icons-react.mjs";
import { n as buttonVariants, r as cn, t as Button$1 } from "./_ssr/button-Byofh5wQ.mjs";
...
import { t as MainHeader } from "./_ssr/main-header-Dvi_EOrD.mjs";
import { t as Badge } from "./_ssr/badge-CNx_OxWt.mjs";
import { t as FadeIn } from "./_ssr/fade-in-F64DNX1t.mjs";
import { t as toCompactNumber } from "./_ssr/number-DKxT4LDg.mjs";
import { t as Route } from "./_slug-DAnEZXkx.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-CrbLJtB6.js
...
function ProjectDetailPage() {
	...
	const { data: project } = useSuspenseQuery(trpc.project.getBySlug.queryOptions({
		slug,
		locale
	}));
	...
	const incrementViews = useMutation({
		...
		onSuccess: () => {
			queryClient.invalidateQueries(trpc.project.getBySlug.queryOptions({
				slug,
				locale
			}));
	...
	const links = [
		{
			...
			label: t.projectDetail.linkGithub
		},
		{
			url: project.liveUrl,
			icon: IconExternalLink,
			label: t.projectDetail.linkLive
		},
		{
			url: project.playstoreUrl,
			icon: IconBrandGooglePlay,
			label: t.projectDetail.linkPlayStore
		},
		{
			url: project.appstoreUrl,
			icon: IconBrandAppstore,
			label: t.projectDetail.linkAppStore
		}
	].filter((l) => !!l.url);
					...
					children: [
						...
						project.longDescription && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: t.projectDetail.about
						...
						galleryImages.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "text-foreground text-sm font-semibold tracking-wide uppercase",
								children: t.projectDetail.gallery
