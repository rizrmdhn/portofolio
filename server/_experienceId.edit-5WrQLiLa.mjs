...
import { _ as IconSettings, mt as IconBriefcase, z as IconLanguage } from "./_libs/tabler__icons-react.mjs";
import { _ as EXPERIENCE_STATUS_TYPES, g as EXPERIENCE_STATUS_LABELS, v as EXPERIENCE_TYPES, y as EXPERIENCE_TYPE_LABELS } from "./_ssr/auth-DYlFpf9M.mjs";
...
import { t as DatePicker } from "./_ssr/date-picker-djhv2Btt.mjs";
...
import { n as updateExperienceSchema } from "./_ssr/experience.schema-3BBcC2mf.mjs";
import { t as Route } from "./_experienceId.edit-CjjwwTM7.mjs";
import { i as TranslationEditor } from "./_ssr/translation-editor-D6Ynl2kU.mjs";
import { n as Switch$1, t as InputTag } from "./_ssr/switch-aiLZ_xDd.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_experienceId.edit-5WrQLiLa.js
var import_jsx_runtime = require_jsx_runtime();
var EXPERIENCE_TRANSLATION_FIELDS = [{
	name: "title",
	label: "Role / Title",
	type: "input",
...
function ExperienceTranslationsTab({ experienceId, sourceValues }) {
	const queryClient = useQueryClient();
	const translationsQuery = useQuery(trpc.experience.getTranslations.queryOptions({ experienceId }));
	const invalidate = () => queryClient.invalidateQueries(trpc.experience.getTranslations.queryFilter({ experienceId }));
	const upsert = useMutation(trpc.experience.upsertTranslation.mutationOptions({
		onSuccess: async () => {
			await invalidate();
	...
	const remove = useMutation(trpc.experience.deleteTranslation.mutationOptions({
		onSuccess: async () => {
			await invalidate();
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
										value: "translations",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExperienceTranslationsTab, {
											experienceId,
											sourceValues: {
												title: experience.title,
												description: experience.description
