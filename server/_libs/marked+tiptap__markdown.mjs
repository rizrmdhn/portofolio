import { C as getSchema, F as sortExtensions, d as decodeHtmlEntities, f as encodeHtmlEntities, h as generateJSON, m as flattenExtensions, r as Extension, s as callOrReturn, u as commands_exports, v as getExtensionField } from "./@tiptap/core+[...].mjs";
...
x.lex;
//#endregion
//#region ../../node_modules/.pnpm/@tiptap+markdown@3.24.0_@tiptap+core@3.24.0_@tiptap+pm@3.24.0__@tiptap+pm@3.24.0/node_modules/@tiptap/markdown/dist/index.js
	...
	registerTokenizer(tokenizer) {
		...
		const markedExtension = {
			...
			tokenizer(src, tokens) {
				const result = tokenize(src, tokens, this.lexer ? createTokenizerHelpers(this.lexer) : createTokenizerHelpers(createLexer()));
...
`);
	...
	*/
	encodeTextForMarkdown(text, node, parentNode) {
		return (parentNode == null ? void 0 : parentNode.type) != null && this.codeTypes.has(parentNode.type) || (node.marks || []).some((m) => this.codeTypes.has(typeof m === "string" ? m : m.type)) ? text : encodeHtmlEntities(text);
	}
