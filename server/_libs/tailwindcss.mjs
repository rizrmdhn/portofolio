//#region ../../node_modules/.pnpm/tailwindcss@4.3.0/node_modules/tailwindcss/dist/chunk-X4GG3EDV.mjs
var l$1 = {
	inherit: "inherit",
...
//#endregion
//#region ../../node_modules/.pnpm/tailwindcss@4.3.0/node_modules/tailwindcss/dist/chunk-TDNFF6A4.mjs
...
new RegExp(`^${x.source}$`);
new RegExp(`^${x.source}%$`);
new RegExp(`^${x.source}\\s*/\\s*${x.source}$`);
new RegExp(`^${x.source}(${[
	"cm",
	"mm",
	"Q",
...
new RegExp(`^${x.source} +${x.source} +${x.source}$`);
function u(e) {
	let t = Number(e);
