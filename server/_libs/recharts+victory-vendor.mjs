...
import { ct as require_react_dom, lt as require_with_selector, mt as require_react } from "./@base-ui/react+[...].mjs";
...
var Surface = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("svg", _extends$26({}, svgPropertiesAndEvents(others), {
...
var Layer = /* @__PURE__ */ import_react.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("g", _extends$25({ className: layerClass }, svgPropertiesAndEvents(others), { ref }), children);
});
//#endregion
...
function noop$1() {}
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/shape/Symbols.js
var _excluded$18 = [
	"type",
	"size",
	"sizeType"
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$43(_objectSpread$43({}, _objectWithoutProperties$18(_ref, _excluded$18)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(size)) return /* @__PURE__ */ import_react.createElement("path", _extends$24({}, filteredProps, {
...
*/
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/component/DefaultLegendContent.js
...
var DefaultLegendContent = (outsideProps) => {
	...
	return /* @__PURE__ */ import_react.createElement("ul", {
		...
		style: finalStyle
	}, /* @__PURE__ */ import_react.createElement(Items, _extends$23({}, props, { payload })));
};
//#endregion
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/context/legendPayloadContext.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/component/Legend.js
...
function LegendImpl(outsideProps) {
	...
	}), /* @__PURE__ */ import_react.createElement(LegendContent, _extends$21({}, props, widthOrHeight, {
		margin,
		chartWidth,
		chartHeight,
		contextPayload
...
var Cross = (_ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$18({}, svgPropertiesAndEvents(props), {
...
*/
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$32(_objectSpread$32({}, res), {}, { [key]: fn(key, obj[key]) }), {});
//#endregion
...
var calStepperVals = (easing, preVals, steps) => {
	var nextStepVals = mapObject((key, val) => {
		if (needContinue(val)) {
			...
			return _objectSpread$31(_objectSpread$31({}, val), {}, {
				from: newX,
				velocity: newV
			});
		}
	...
	if (steps < 1) return mapObject((key, val) => {
		if (needContinue(val) && nextStepVals[key] != null) return _objectSpread$31(_objectSpread$31({}, val), {}, {
...
function createStepperUpdate(from, to, easing, interKeys, render, timeoutController) {
	var preTime;
	var stepperStyle = interKeys.reduce((res, key) => _objectSpread$31(_objectSpread$31({}, res), {}, { [key]: {
		from: from[key],
		velocity: 0,
		to: to[key]
	} }), {});
	...
	var stepperUpdate = (now) => {
		...
		render(_objectSpread$31(_objectSpread$31(_objectSpread$31({}, from), to), getCurrStyle()));
		preTime = now;
...
function createTimingUpdate(from, to, easing, duration, interKeys, render, timeoutController) {
	...
	var timingStyle = interKeys.reduce((res, key) => {
		...
		return _objectSpread$31(_objectSpread$31({}, res), {}, { [key]: [fromElement, toElement] });
	}, {});
	var beginTime;
	var timingUpdate = (now) => {
		...
		render(_objectSpread$31(_objectSpread$31(_objectSpread$31({}, from), to), currStyle));
		if (t < 1) stopAnimation = timeoutController.setTimeout(timingUpdate);
			...
			render(_objectSpread$31(_objectSpread$31(_objectSpread$31({}, from), to), finalStyle));
		}
	};
	return () => {
...
var configUpdate_default = (from, to, easing, duration, render, timeoutController) => {
	...
	if (easing == null) return () => {
		render(_objectSpread$31(_objectSpread$31({}, from), to));
		return () => {};
	};
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		...
		return /* @__PURE__ */ import_react.createElement("path", _extends$17({}, otherPathProps, {
			x: round(x),
			y: round(y),
			width: round(width),
			height: round(height),
	...
	return /* @__PURE__ */ import_react.createElement(JavascriptAnimate, {
		...
		return /* @__PURE__ */ import_react.createElement("path", _extends$17({}, otherPathProps, {
			...
			ref: pathRef,
			style: _objectSpread$30(_objectSpread$30({}, animationStyle), props.style)
		}));
	});
};
//#endregion
...
var inRangeOfSector = (_ref5, viewBox) => {
	...
	if (inRange) return _objectSpread$29(_objectSpread$29({}, viewBox), {}, {
		radius,
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
	...
	return _objectSpread$28(_objectSpread$28({}, implicitAngleAxis), {}, { type: evaluatedType });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
	...
	return _objectSpread$28(_objectSpread$28({}, implicitRadiusAxis), {}, { type: evaluatedType });
});
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
	if (axis == null || scale == null) return;
	return _objectSpread$27(_objectSpread$27({}, axis), {}, { scale });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
	...
	if (hasBeenActivePreviously(appropriateMouseInteraction)) {
		if (activeFromProps) return _objectSpread$26(_objectSpread$26({}, appropriateMouseInteraction), {}, { active: true });
	...
	return _objectSpread$26(_objectSpread$26({}, noInteraction), {}, { coordinate: appropriateMouseInteraction.coordinate });
};
//#endregion
...
var combineTooltipPayload = (tooltipPayloadConfigurations, activeIndex, chartDataState, tooltipAxisDataKey, activeLabel, tooltipPayloadSearcher, tooltipEventType) => {
	...
	return tooltipPayloadConfigurations.reduce((agg, _ref) => {
		...
		if (Array.isArray(tooltipPayload)) tooltipPayload.forEach((item) => {
			...
			var newSettings = _objectSpread$25(_objectSpread$25({}, settings), {}, {
				name: itemName,
...
var useTooltipAxisBandSize = () => {
	...
	return getBandSizeOfAxis(_objectSpread$24(_objectSpread$24({}, tooltipAxis), {}, { scale: tooltipAxisScale }), tooltipTicks);
};
//#endregion
...
var initialState$4 = { zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current) => _objectSpread$22(_objectSpread$22({}, acc), {}, { [current]: {
	element: void 0,
...
function CursorInternal(props) {
	...
	var cursorProps = _objectSpread$21(_objectSpread$21(_objectSpread$21(_objectSpread$21({
		stroke: "#ccc",
		pointerEvents: "none"
...
function Cursor(props) {
	...
	return /* @__PURE__ */ import_react.createElement(CursorInternal, _extends$15({}, props, {
		offset,
		layout,
		tooltipAxisBandSize,
		chartName
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					...
					var scaledCoordinate = _objectSpread$20(_objectSpread$20({}, otherCoordinateProps), {}, {
						x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
						y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
					});
					dispatch(_objectSpread$20(_objectSpread$20({}, action), {}, { payload: _objectSpread$20(_objectSpread$20({}, action.payload), {}, { coordinate: scaledCoordinate }) }));
...
function Tooltip(outsideProps) {
	...
	var tooltipContentProps = _objectSpread$19(_objectSpread$19({}, props), {}, {
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/component/Cell.js
/**
...
var LRUCache = class {
	constructor(maxSize) {
		_defineProperty$20(this, "cache", /* @__PURE__ */ new Map());
...
var currentConfig = _objectSpread$18({}, {
	cacheSize: 2e3,
	enableCache: true
});
...
_defineProperty$18(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
var Text = /* @__PURE__ */ (0, import_react.forwardRef)((outsideProps, ref) => {
	...
	return /* @__PURE__ */ import_react.createElement("text", _extends$14({}, svgPropertiesAndEvents(textProps), {
		ref,
		x,
		y,
...
var getCartesianPosition = (options) => {
	...
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$17({
...
var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
	...
	return /* @__PURE__ */ import_react.createElement("text", _extends$13({}, attrs, {
...
function Label(outerProps) {
	...
	var propsWithViewBox = _objectSpread$16(_objectSpread$16({}, props), {}, { viewBox });
	...
	if (isPolar(viewBox)) {
		...
		positionAttrs = _objectSpread$16(_objectSpread$16({
			x: cartesianResult.x,
			y: cartesianResult.y,
	...
	return /* @__PURE__ */ import_react.createElement(ZIndexLayer, { zIndex: props.zIndex }, /* @__PURE__ */ import_react.createElement(Text, _extends$13({
		ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
	...
	if (label === true) return /* @__PURE__ */ import_react.createElement(Label, _extends$13({ key: "label-implicit" }, commonProps));
	if (isNumOrStr(label)) return /* @__PURE__ */ import_react.createElement(Label, _extends$13({
		key: "label-implicit",
		value: label
	}, commonProps));
	if (/* @__PURE__ */ (0, import_react.isValidElement)(label)) {
		if (label.type === Label) return /* @__PURE__ */ (0, import_react.cloneElement)(label, _objectSpread$16({ key: "label-implicit" }, commonProps));
		return /* @__PURE__ */ import_react.createElement(Label, _extends$13({
			key: "label-implicit",
			content: label
		}, commonProps));
	}
	if (isLabelContentAFunction(label)) return /* @__PURE__ */ import_react.createElement(Label, _extends$13({
		key: "label-implicit",
		content: label
	}, commonProps));
	if (label && typeof label === "object") return /* @__PURE__ */ import_react.createElement(Label, _extends$13({}, label, { key: "label-implicit" }, commonProps));
	return null;
};
...
function LabelList(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement(ZIndexLayer, { zIndex: zIndex !== null && zIndex !== void 0 ? zIndex : DefaultZIndexes.label }, /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map((entry, index) => {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$12({ key: "label-".concat(index) }, svgPropertiesAndEvents(entry), others, idProps, {
...
function LabelListFromLabelProp(_ref2) {
	...
	if (typeof label === "object") return /* @__PURE__ */ import_react.createElement(LabelList, _extends$12({ key: "labelList-implicit" }, label, { type: String(label.type) }));
	return null;
}
//#endregion
...
var Dot = (props) => {
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(r)) return /* @__PURE__ */ import_react.createElement("circle", _extends$11({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/state/selectors/polarSelectors.js
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/state/selectors/pieSelectors.js
...
var selectDisplayedData = createSelector([
	...
	if ((!displayedData || !displayedData.length) && cells != null) displayedData = cells.map((cell) => _objectSpread$15(_objectSpread$15({}, pieSettings.presentationProps), cell.props));
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/util/ReactUtils.js
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/shape/Trapezoid.js
/**
* @fileOverview Rectangle
*/
...
var Trapezoid = (outsideProps) => {
	...
	return /* @__PURE__ */ import_react.createElement(JavascriptAnimate, {
		...
		return /* @__PURE__ */ import_react.createElement("path", _extends$10({}, svgPropertiesAndEvents(trapezoidProps), {
			...
			ref: pathRef,
			style: _objectSpread$14(_objectSpread$14({}, animationStyle), trapezoidProps.style)
		}));
	});
};
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/util/ActiveShapeUtils.js
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/context/tooltipContext.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/polar/Pie.js
var _excluded$9 = ["key"], _excluded2$4 = [
	"onMouseEnter",
	"onClick",
	"onMouseLeave"
], _excluded3$2 = ["id"], _excluded4$1 = ["id"];
function _extends$9() {
...
var renderLabelLineItem = (option, props) => {
	...
	var { key } = props, otherProps = _objectWithoutProperties$9(props, _excluded$9);
...
var renderLabelItem = (option, props, value) => {
	...
	return /* @__PURE__ */ import_react.createElement(Text, _extends$9({}, props, {
...
function PieSectors(props) {
	...
	var activeGraphicalItemId = useAppSelector(selectActiveTooltipGraphicalItemId);
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = allOtherPieProps, restOfAllOtherProps = _objectWithoutProperties$9(allOtherPieProps, _excluded2$4);
...
function PieImpl(props) {
	var { id } = props, propsWithoutId = _objectWithoutProperties$9(props, _excluded3$2);
...
function PieFn(outsideProps) {
	...
	var { id: externalId } = props, propsWithoutId = _objectWithoutProperties$9(props, _excluded4$1);
...
var CartesianAxisComponent = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	var { axisLine, width, height, className, hide, ticks, axisType, axisId } = props, rest = _objectWithoutProperties$7(props, _excluded$7);
...
function LineItem(_ref) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) lineItem = /* @__PURE__ */ import_react.cloneElement(option, lineItemProps);
		...
		var _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(_objectWithoutProperties$6(lineItemProps, _excluded$6))) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, { offset: __ } = _ref2, restOfFilteredProps = _objectWithoutProperties$6(_ref2, _excluded2$3);
...
function HorizontalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$6(props, _excluded3$1);
...
var _excluded$5 = ["id"], _excluded2$2 = [
	"activeDot",
	"animationBegin",
	"animationDuration",
	"animationEasing",
...
function StaticArea(_ref4) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ import_react.createElement(Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0 }, /* @__PURE__ */ import_react.createElement(Curve, _extends$5({}, propsWithEvents, {
		...
		fill: "none",
		points
	})), stroke !== "none" && isRange && Array.isArray(baseLine) && /* @__PURE__ */ import_react.createElement(Curve, _extends$5({}, allOtherProps, {
		className: "recharts-area-curve",
		layout,
		type,
		connectNulls,
...
function AreaImpl(props) {
	var _useAppSelector;
	var { activeDot, animationBegin, animationDuration, animationEasing, connectNulls, dot, fill, fillOpacity, hide, isAnimationActive, legendType, stroke, xAxisId, yAxisId } = props, everythingElse = _objectWithoutProperties$5(props, _excluded2$2);
	var layout = useChartLayout();
	var chartName = useChartName();
...
var _excluded$4 = ["domain", "range"], _excluded2$1 = ["domain", "range"];
...
function axisPropsAreEqual(prevProps, nextProps) {
	...
	var { domain: nextDomain, range: nextRange } = nextProps, nextRest = _objectWithoutProperties$4(nextProps, _excluded2$1);
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/state/ReportPolarOptions.js
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/chart/PolarChart.js
...
//#endregion
//#region ../../node_modules/.pnpm/recharts@3.8.0_@types+react@19.2.14_react-dom@19.2.6_react@19.2.6__react-is@17.0.2_react@19.2.6_redux@5.0.1/node_modules/recharts/es6/chart/PieChart.js
...
//#endregion
export { CartesianGrid as a, Tooltip as c, Area as i, Legend as l, PieChart as n, Pie as o, XAxis as r, Cell as s, AreaChart as t, ResponsiveContainer as u };
