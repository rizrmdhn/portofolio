...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DmWRVUFf.mjs");
...
var manifest = { "659a96a03a9626f0844164fe430e164571be9100b882d85c6383faef18ff46d2": {
	functionName: "getUser_createServerFn_handler",
	importer: () => import("./get-user-CT3AqioI.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ba8N_w5h.mjs"),
		import("./start-C4iaBFB0.mjs"),
