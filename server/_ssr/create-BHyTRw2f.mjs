...
import { _ as EXPERIENCE_STATUS_TYPES, g as EXPERIENCE_STATUS_LABELS, v as EXPERIENCE_TYPES, y as EXPERIENCE_TYPE_LABELS } from "./auth-DYlFpf9M.mjs";
...
import { t as DatePicker } from "./date-picker-djhv2Btt.mjs";
import { t as ScrollArea$1 } from "./scroll-area-DTrDwLXS.mjs";
...
import { t as hasTabError } from "./has-tab-error-8GKW7_Vv.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select$1 } from "./select-DywxwuYX.mjs";
import { t as createExperienceSchema } from "./experience.schema-3BBcC2mf.mjs";
import { a as completeDraftLocales, o as resolveDraftLocale, r as TranslationDraftEditor } from "./translation-editor-D6Ynl2kU.mjs";
import { n as Switch$1, t as InputTag } from "./switch-aiLZ_xDd.mjs";
import { t as Route } from "./create-BjyAoyrM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/create-BHyTRw2f.js
...
function RouteComponent() {
	...
	const setTranslationField = (locale, name, value) => setTranslations((prev) => ({
		...prev,
		[locale]: {
			...prev[locale],
			[name]: value
	...
	const form = useForm({
		...
		onSubmit: async ({ value }) => {
			...
			for (const locale of completeDraftLocales(translations, EXPERIENCE_TRANSLATION_FIELDS, source)) {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(form.Subscribe, {
											...
											children: (v) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TranslationDraftEditor, {
