...
//#region node_modules/.nitro/vite/services/ssr/assets/achievement-BhGEjNoV.js
var import_jsx_runtime = require_jsx_runtime();
var $$splitComponentImporter = () => import("./achievement-CMO2Ep9u.mjs");
var Route = createFileRoute("/(core)/dashboard/achievement/")({
	validateSearch: zod_default.object({ search: zod_default.string().optional() }),
	beforeLoad: async ({ search, context }) => {
		await context.queryClient.ensureQueryData(context.trpc.achievement.getForDashboard.queryOptions(search));
	},
