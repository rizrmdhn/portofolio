...
import { $ as IconDownload } from "../_libs/tabler__icons-react.mjs";
import { t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { r as trpc } from "./trpc-DhZOnnjr.mjs";
import { t as MainHeader } from "./main-header-CwoxlNeR.mjs";
import { t as Route } from "./resume-Dwz950lg.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/resume-CeuQAIIR.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MainHeader, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				className: "flex flex-col items-center gap-4 rounded-lg border border-border p-8 md:hidden",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted-foreground",
					children: "PDF preview is not available on mobile browsers."
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconDownload, { className: "size-4" }), "Open PDF"]
				})]
