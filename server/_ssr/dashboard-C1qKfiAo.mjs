...
import { I as IconLink, J as IconFolder, Mt as IconArrowRight, U as IconHistory, X as IconFileCv, Z as IconEye, a as IconWorldWww, b as IconSchool, c as IconTrophy, ft as IconCertificate, kt as IconAt, m as IconStack2, mt as IconBriefcase, o as IconUser, tt as IconDevices } from "../_libs/tabler__icons-react.mjs";
import { C as SOCIAL_ICON_MAP, t as ACTIVITY_LOG_ENTITY_LABELS } from "./auth-Dexh0mOC.mjs";
...
import { i as CardDescription, n as CardAction, o as CardHeader, r as CardContent, s as CardTitle, t as Card } from "./card-DzVnM7at.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-C1qKfiAo.js
	...
	const { chartData, chartConfig } = (0, import_react.useMemo)(() => {
		...
		return {
			chartData: data.map((d, idx) => {
				const color = SLICE_COLORS$1[idx % SLICE_COLORS$1.length];
				config[d.deviceType] = {
...
function ReferralBreakdownCard({ className, data }) {
	...
	const { chartData, chartConfig } = (0, import_react.useMemo)(() => {
		...
		return {
			chartData: data.map((d, idx) => {
				...
				config[d.referral] = {
					label: REFERRAL_LABELS[d.referral],
					color
				};
				return {
					...d,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
			className: "border-b",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "Referral Sources" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, { children: "Where visitors came from" })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
			className: "pt-4",
			children: total === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				icon: IconLink,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PieChart, { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pie, {
						...
						innerRadius: 55,
						strokeWidth: 2,
						children: chartData.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cell, { fill: entry.fill }, entry.referral))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartLegend, {
						content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartLegendContent, { nameKey: "referral" }),
						className: "flex-wrap gap-2"
					})
				] })
			})
...
function RouteComponent() {
	...
	const { data: referralBreakdown } = useSuspenseQuery(trpc.dashboard.getReferralBreakdown.queryOptions());
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AllTimeProjectsCard, { projects: allTimeViewsProjects }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SocialLinkClickThroughCard, { socialLinks }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReferralBreakdownCard, { data: referralBreakdown })
				]
			}),
