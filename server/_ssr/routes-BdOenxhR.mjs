...
import { A as IconMail, dt as IconCertificate, jt as IconArrowRight, m as IconStack2, pt as IconBriefcase, q as IconFolder } from "../_libs/tabler__icons-react.mjs";
import { S as SOCIAL_ICON_MAP, n as AVAILABILITY_STATUS_LABELS, y as EXPERIENCE_TYPE_LABELS } from "./auth-BlELRVlC.mjs";
...
import { t as FadeIn } from "./fade-in-Bl28mE8s.mjs";
...
import { t as Route } from "./routes-B1aXlrRa.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BdOenxhR.js
...
function ExperienceCard({ experience, className, ...props }) {
	...
	const duration = formatDuration(experience.startDate, experience.currentlyWorking ? /* @__PURE__ */ new Date() : endDate);
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: EXPERIENCE_TYPE_LABELS[experience.type] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								"aria-hidden": true,
								children: "·"
							}),
