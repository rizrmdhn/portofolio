...
import { _t as projects, a as COLOR_VALUES, h as EXPERIENCE_STATUS_TYPES } from "./auth-BOIJqjd1.mjs";
import { t as createInsertSchema } from "./schema-C2gAthpC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/project.schema-CaO0cEu4.js
...
var createProjectSchema = createInsertSchema(projects, {
	...
	picture: zod_default.file().max(5 * 1024 * 1024).or(zod_default.undefined()),
...
//#endregion
export { updateProjectSchema as i, getProjectsSchema as n, reorderProjectsSchema as r, createProjectSchema as t };
