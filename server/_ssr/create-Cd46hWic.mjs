...
import { _ as IconSettings, c as IconTrophy } from "../_libs/tabler__icons-react.mjs";
import { _ as EXPERIENCE_STATUS_TYPES, g as EXPERIENCE_STATUS_LABELS } from "./auth-DYlFpf9M.mjs";
import { t as Button$1 } from "./button-Byofh5wQ.mjs";
import { t as createAchievementSchema } from "./achievement.schema-BhYXW9ju.mjs";
...
import { a as FieldLabel, i as FieldGroup, n as FieldDescription, o as Spinner, r as FieldError, t as Field } from "./spinner-D1JR_mQq.mjs";
...
import { t as Route } from "./create-DtaA7U_8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/create-Cd46hWic.js
...
function RouteComponent() {
	...
	const createMutation = useMutation(trpc.achievement.create.mutationOptions({
		onSuccess: async () => {
			await queryClient.invalidateQueries(trpc.achievement.getForDashboard.queryFilter());
			globalSuccessToast("Achievement created successfully!");
			navigate({ to: "/dashboard/achievement" });
		},
		onError: (err) => globalErrorToast(err.message)
	}));
	const form = useForm({
		validators: { onSubmit: createAchievementSchema },
		defaultValues: {
			title: "",
			issuer: "",
			description: void 0,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: "Add a new achievement to your resume."
			})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button$1, {
							...
							children: (isSubmitting) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$1, {
								...
								children: [isSubmitting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Spinner, { "data-icon": "inline-start" }) : null, "Add Achievement"]
							})
						})]
					})
				]
